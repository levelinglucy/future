...
class DB:
    ...
    def normalize_meta(self, meta):
        ...
        if not isinstance(out.get('next_actions'), list):
            out['next_actions'] = []
        for key in ['human_notes', 'agent_notes', 'machine_summary']:
...
class EntryForm(ui.View):
    def __init__(self, db, refresh_callback, entry_id=None):
        ...
        self.add_subview(self.links_preview)
        ...
        self.add_subview(self.backlinks_preview)
        ...
        self.add_subview(self.symbolic_weight_seg)

        self.confidence_lbl = ui.Label(frame=(230, y + 438, 100, 20), text='Confidence')
        self.add_subview(self.confidence_lbl)
        ...
        self.add_subview(self.confidence_seg)

        self.human_notes_lbl = ui.Label(frame=(12, y + 500, 140, 20), text='Human Notes')
        self.add_subview(self.human_notes_lbl)
        ...
        self.add_subview(self.human_notes_tv)

        self.agent_notes_lbl = ui.Label(frame=(12, y + 602, 140, 20), text='Agent Notes')
        self.add_subview(self.agent_notes_lbl)
        ...
        self.add_subview(self.agent_notes_tv)

        self.machine_summary_lbl = ui.Label(frame=(12, y + 704, 160, 20), text='Machine Summary')
        self.add_subview(self.machine_summary_lbl)
        ...
        self.add_subview(self.machine_summary_tv)

        self.next_actions_lbl = ui.Label(frame=(12, y + 806, 160, 20), text='Next Actions')
        self.add_subview(self.next_actions_lbl)
        ...
        self.add_subview(self.next_actions_tv)
        ...
        self.add_subview(self.preview_btn)
...
class MainView(ui.View):
    def __init__(self):
        super().__init__()
        self.db = DB(DB_PATH)
        self.name = 'Continuity Workbench v3.3.1'
        self.background_color = 'white'
